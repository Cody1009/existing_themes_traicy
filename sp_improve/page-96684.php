...
<?php //サイト上部 ?>
          ...
          <img class="recruit-top-img" src="https://www.traicy.com/wp-content/uploads/2018/10/wanted-top.png" alt="">
            <div class="center-contents">
              <div class="wanted-container ">
                    ...
                    <p class="static-page-title-text"> 募集職種 </p>
                    <div class="black-horizontal-devider"></div>
                    <ul class="uls" style="list-style-type: decimal">
                        <li class="static-page-body-text">営業・企画・マーケティング</li>
                        <li class="static-page-body-text">記事執筆ライター</li>
                        <li class="static-page-body-text">デザイナー</li>
                        <li class="static-page-body-text">プログラマー</li>
                    </ul>
                    ...
                    <div class="black-horizontal-devider"></div>
                    <p class="static-page-body-text">東京・秋葉原（東京メトロ神田駅徒歩3分、JR秋葉原駅徒歩3分、JR神田駅徒歩6分）<br>勤務になれてきた場合は、リモートワークも可。</p>

                    <br>

                    <p class="static-page-title-text"> 仕事内容 </p>
                    <div class="black-horizontal-devider"></div>

                    <br>

                    <p class="static-page-body-bold">1.営業・企画・マーケティング</p>
                    ...
                    <p class="static-page-body-bold">2.記事執筆ライター</p>
                    <ul class="uls" style="list-style-type: disc">
                    ...
                    <p class="static-page-body-bold">3.デザイナー</p>
                    <ul class="uls" style="list-style-type: disc">
                    ...
                    <p class="static-page-body-bold">4.プログラマー</p>
                    <ul class="uls" style="list-style-type: disc">
                    ...
                    <p class="static-page-title-text"> 好ましい人材 </p>
                    <div class="black-horizontal-devider"></div>
                    ...
                    <p class="static-page-body-bold">1.営業・企画・マーケティング</p>
                    <ul class="uls" style="list-style-type: disc">
                        <li class="static-page-body-text">コミュニケーションが好きな人</li>
                        <li class="static-page-body-text">新規営業先開拓を粘り強く進んでできる人</li>
                    </ul>
                    ...
                    <p class="static-page-body-bold">4.プログラマー</p>
                    <ul class="uls" style="list-style-type: disc">
                        <li class="static-page-body-text">WordPressかRailsの基礎的知識がある方（ネット上での動画レッスンなどでも可）</li>
                        <li class="static-page-body-text">長期的に勤務できる方。(大学1/2年生から卒業まで等。)</li>
                    </ul>

                    <br>

                    <p class="static-page-title-text"> 雇用形態 </p>
                    <div class="black-horizontal-devider"></div>
                    <ul class="uls" style="list-style-type: disc">
                    ...
                    <p class="static-page-title-text"> 採用までの流れ </p>
                    <div class="black-horizontal-devider"></div>
                    <div class="flow-for-application">
                        <p class="static-page-body-text">ご応募</p>
                        <i class="fa fa-angle-down flow-angle-down" aria-hidden="true"></i>
                        <p class="static-page-body-text flow-angle-down">採用担当からのご連絡</p>
                        <i class="fa fa-angle-down flow-angle-down" aria-hidden="true"></i>
                        <p class="static-page-body-text">面接</p>
                        <i class="fa fa-angle-down flow-angle-down" aria-hidden="true"></i>
                        <p class="static-page-body-text">採用決定</p>
                    </div>
                    ...
                    <p class="static-page-title-text">一問一答</p>
                    <div class="black-horizontal-devider"></div><br>
                        <li class="static-page-body-bold" style="list-style: none">どんな人が何人が働いていますか？</li>
                            <ul class="uls" style="list-style-type: disc">
                                <li class="static-page-body-text">概ね10名弱程度</li>
                                <li class="static-page-body-text">平均年齢20代半ば</li>
                                <li class="static-page-body-text">東京近郊の大学生が主。</li>
                                <li class="static-page-body-text">常に全員が出勤するわけではなく、最大でも5人程度です。</li>
                            </ul>
 ...
                        <li class="static-page-body-bold" style="list-style: none">時給はいくらからですか？</li>
                        ...
                        <br>
                        <li class="static-page-body-bold" style="list-style: none">仕事しているところを見学したいです</li>
                            <ul class="uls" style="list-style-type: disc">
                                <li class="static-page-body-text">面接時にご希望でしたら可能です。</li>
                            </ul>

                        <br>
                        <li class="static-page-body-bold" style="list-style: none">面接に必要なものは何ですか？</li>
                            <ul class="uls" style="list-style-type: disc">
                                <li class="static-page-body-text">履歴書（写真貼付）、ノートパソコンのみです。</li>
                                <li class="static-page-body-text">服装は私服で大丈夫です。</li>
                                <li class="static-page-body-text">他に指定の物のほか、自身のアピールになるもの等があれば合わせてお持ちください。</li>
                            </ul>

                        <br>
                        <li class="static-page-body-bold" style="list-style: none">面接の内容、所要時間はどれくらいですか？</li>
                            <ul class="uls" style="list-style-type: disc">
                        ...
                        <br>
                        <li class="static-page-body-bold" style="list-style: none">給料の支払いはいつですか？</li>
                            <ul class="uls" style="list-style-type: disc">
                        ...
                        <br>
                        <li class="static-page-body-bold" style="list-style: none">試験期間中や旅行の際は休めますか？</li>
                            <ul class="uls" style="list-style-type: disc">
                    ...
                    <div id="applicationPage">
                        <center>
                            <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfdwsw0hp6zE8RBaazq3PvCyGfyRZdZNy8Hmfp4M9qjiVw52g/viewform?embedded=true"
                                    width="95%" height="1600px;" frameborder="0" marginheight="0" marginwidth="0">読み込んでいます...
                            </iframe>
                        </center>
                    </div>
                </div>
