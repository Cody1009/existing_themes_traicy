        ...
        <div class="content-box-row">
            <div class="center-contents">
                <div id="wanted-container">
                    ...
                    <ul class="uls">
                        <li class="static-page-body-text">1.<?= $sales; ?></li>
                        <li class="static-page-body-text">2.<?= $writer; ?></li>
                        <li class="static-page-body-text">3.<?= $designer; ?></li>
                        <li class="static-page-body-text">4.<?= $programmer; ?></li>
                    </ul>
                    ...
                    <p class="static-page-body-bold">1.<?= $sales; ?>のみ</p>
                    <ul class="uls" style="list-style-type: disc">
                    ...
                    <p class="static-page-title-text"> 給与 </p>
                    <div class="black-horizontal-devider"></div>
                    <ul class="uls" style="list-style-type: disc">
                           
                    ...
                    <p class="static-page-title-text"> 採用までの流行 </p>
                    <div class="black-horizontal-devider"></div>
                    ...
                    <div class="black-horizontal-devider"></div>
                    <ul class="uls" style="list-style-type: disc">
                        <li style="list-style: none" class="static-page-body-bold">どんな人が何人が働いていますか
                            <ul class="uls" style="list-style-type: disc">
                        ...
                        <br>
                        <li class="static-page-body-bold" style="list-style: none">仕事しているところを見学したいです
                            <ul class="uls" style="list-style-type: disc">
                                <li class="static-page-body-text">面接時にご希望でしたら可能です。</li>
                            </ul>
                        </li>
                        <br>
                        <li class="static-page-body-bold" style="list-style: none">面接に必要なものは何ですか
                            <ul class="uls" style="list-style-type: disc">
