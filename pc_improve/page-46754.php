                    ...
                    <div class="flexBox">
                        ...
                        <div class=right>
                            <ul>
                                ...
                                <li>価格比較</li>
                                <ul>
                                    <li><i class="fa fa-wifi" aria-hidden="true"></i><a href="https://www.traicy.com/wifi">Wifi比較</a></li>
                                    <li><i class="fa fa-plane" aria-hidden="true"></i><a href="http://airticket.traicy.com/ja-JP/flights">航空券比較</a></li>
                                    <li><i class="fa fa-car" aria-hidden="true"></i><a href="http://h.accesstrade.net/sp/cc?rk=0100kmfy00ada9">レンタカー比較</a></li>
                                </ul>
